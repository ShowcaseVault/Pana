...
async def get_recordings_endpoint(
    ...
    return SuccessResponse(data=recordings, message="Recordings retrieved successfully")


@router.get("/{recording_id}", response_model=SuccessResponse | FailureResponse)
...
@router.patch("/{recording_id}", response_model=SuccessResponse | FailureResponse)
...
@router.delete("/{recording_id}", response_model=SuccessResponse | FailureResponse)
