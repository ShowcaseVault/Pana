...
async def create_recording(
    db: AsyncSession, file: UploadFile, user_id: int, user_sub: str, recording_data: RecordingCreate
):
    """
...
async def get_all_recordings(
    ...
    return {
        "total": total,
        "data": [RecordingResponse.model_validate(recording) for recording in recordings],
    }
